...
double bbob2009_compute_fopt(const size_t function, const size_t instance)
{
    ...
    if (function == 4)
        ...
        rseed = 17;
    else if (function == 101 || function == 102 || function == 103 || function == 107 || function == 108 || function == 109)
        rseed = 1;
    else if (function == 104 || function == 105 || function == 106 || function == 110 || function == 111 || function == 112)
        rseed = 8;
